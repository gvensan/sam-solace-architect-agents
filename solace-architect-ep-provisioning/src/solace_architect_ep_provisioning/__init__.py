"""solace-architect-ep-provisioning plugin — Opt-in live EP provisioning via EP Designer MCP. Strictly opt-in (intake.preferences.provision_event_portal). Never silently skips."""
